...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/MuthukumarPhoton/JailBreakDetectLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'MuthukumarPhoton' => 'muthukumar.mariyappan@photoninfotech.net' }
  s.source           = { :git => 'https://github.com/MuthukumarPhoton/JailBreakDetectLib.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'
  s.swift_versions    = ["4.2"]

  s.source_files = 'JailBreakDetectLib/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JailBreakDetectLib' => ['JailBreakDetectLib/Assets/*.png']
  # }
